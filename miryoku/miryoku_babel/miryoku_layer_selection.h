...
#if !defined(MIRYOKU_LAYER_MACR)
  #define MIRYOKU_LAYER_MACR MIRYOKU_ALTERNATIVES_MACR
#endif
#if !defined(MIRYOKU_LAYERMAPPING_MACR)
  #define MIRYOKU_LAYERMAPPING_MACR MIRYOKU_MAPPING
#endif
